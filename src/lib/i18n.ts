...
export const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'plan.empty.sub':
      'A routine is a workout you plan once and repeat. Import brings yours across; building one here comes next.',
  ...
  ar: {
    ...
    'plan.empty.sub':
      'الروتين تمرين تخطّطه مرة وتكرّره. الاستيراد ينقل روتيناتك، وإنشاء واحد هنا يأتي لاحقاً.',
