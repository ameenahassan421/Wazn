...
export const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'nav.plan': 'Plan',
    'nav.crew': 'Crew',
    'crew.kicker': 'This week',
    'crew.you': 'You',
    'crew.someone': 'A lifter',
    'crew.of': '{done} of {goal}',
    'crew.average': '{avg} a week over the last four',
    ...
    'crew.invite.working': 'Getting your link…',
    'crew.invite.body': 'Training on Wazn. Come keep me honest: {url}',
    'crew.invite.failed': 'Could not make your invite link. Try again.',
    'invite.wants_you': '{name} wants you on the board.',
    'invite.expired': 'That invite has expired.',
    'invite.week': '{n} sessions this week',
    'invite.week_of': '{n} of {goal} this week',
    'invite.next.signed_in': 'Open Crew to follow them back.',
    'invite.next.signed_out':
      'Make an account and they will be waiting on your Crew tab.',
    'nav.train': 'Train',
    ...
    'plan.due': 'Up next',
    'plan.start': 'Start {name}',
    'plan.busy': 'A workout is already running.',
    'plan.exercises': '{n} exercises',
    'plan.exercises_one': '1 exercise',
    'plan.sets': '{n} sets',
    'plan.sets_one': '1 set',
    ...
    'plan.error': 'Could not load your routines.',
    'plan.new': 'New routine',
    'plan.edit': 'Edit',
    'routine.new': 'New routine',
    'routine.edit': 'Edit routine',
    'routine.name': 'Routine name',
    'routine.name.placeholder': 'Upper push',
    'routine.lifts': 'Lifts',
    'routine.no_lifts': 'No lifts yet. Add the first one below.',
    'routine.sets': '{n} sets',
    'routine.sets_one': '1 set',
    'routine.up': 'Up',
    'routine.down': 'Down',
    'routine.remove': 'Remove',
    'routine.save': 'Save routine',
    'routine.delete': 'Delete routine',
    'routine.delete.body': 'Delete {name}? The workouts you logged from it stay.',
    'routine.delete.ok': 'Delete',
    'routine.unnamed': 'Unknown lift',
    'routine.untitled': 'this routine',
    'routine.gone': 'That routine no longer exists.',
    'routine.load_failed': 'Could not open that routine.',
    'routine.save_failed': 'Could not save your routine.',
    'routine.delete_failed': 'Could not delete that routine.',
    'nav.history': 'History',
  ...
  ar: {
    ...
    'nav.plan': 'الخطة',
    'nav.crew': 'الفريق',
    'crew.kicker': 'هذا الأسبوع',
    'crew.you': 'أنت',
    'crew.someone': 'أحد المتدربين',
    'crew.of': '{done} من {goal}',
    ...
    'crew.invite': 'ادعُ شخصاً',
    'crew.invite.working': 'جارٍ تجهيز رابطك…',
    'crew.invite.body': 'أتدرّب على وزن. تعال راقب التزامي: {url}',
    'crew.invite.failed': 'تعذّر إنشاء رابط الدعوة. حاول مرة أخرى.',
    'invite.wants_you': '{name} يريدك على اللوحة.',
    'invite.expired': 'انتهت صلاحية هذه الدعوة.',
    'invite.week': '{n} حصص هذا الأسبوع',
    'invite.week_of': '{n} من {goal} هذا الأسبوع',
    'invite.next.signed_in': 'افتح الفريق لمتابعته.',
    'invite.next.signed_out': 'أنشئ حساباً وسيكون بانتظارك في تبويب الفريق.',
    'nav.train': 'التمرين',
    ...
    'plan.due': 'التالي',
    'plan.start': 'ابدأ {name}',
    'plan.busy': 'هناك تمرين قيد التنفيذ بالفعل.',
    'plan.exercises': '{n} تمارين',
    'plan.exercises_one': 'تمرين واحد',
    'plan.sets': '{n} مجموعات',
    ...
    'plan.error': 'تعذّر تحميل روتيناتك.',
    'plan.new': 'روتين جديد',
    'plan.edit': 'تعديل',
    'routine.new': 'روتين جديد',
    'routine.edit': 'تعديل الروتين',
    'routine.name': 'اسم الروتين',
    'routine.name.placeholder': 'دفع علوي',
    'routine.lifts': 'التمارين',
    'routine.no_lifts': 'لا توجد تمارين بعد. أضف الأول بالأسفل.',
    'routine.sets': '{n} مجموعات',
    'routine.sets_one': 'مجموعة واحدة',
    'routine.up': 'أعلى',
    'routine.down': 'أسفل',
    'routine.remove': 'إزالة',
    'routine.save': 'حفظ الروتين',
    'routine.delete': 'حذف الروتين',
    'routine.delete.body': 'حذف {name}؟ التمارين التي سجّلتها منه تبقى.',
    'routine.delete.ok': 'حذف',
    'routine.unnamed': 'تمرين غير معروف',
    'routine.untitled': 'هذا الروتين',
    'routine.gone': 'هذا الروتين لم يعد موجوداً.',
    'routine.load_failed': 'تعذّر فتح هذا الروتين.',
    'routine.save_failed': 'تعذّر حفظ الروتين.',
    'routine.delete_failed': 'تعذّر حذف هذا الروتين.',
    'nav.history': 'السجل',
    'nav.progress': 'التقدم',
    'nav.coach': 'المدرب',
